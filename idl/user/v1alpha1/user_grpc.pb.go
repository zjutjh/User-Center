...
const (
	UserCenterService_Register_FullMethodName      = "/zjut.jh.usercenter.v1alpha1.UserCenterService/Register"
	UserCenterService_Login_FullMethodName         = "/zjut.jh.usercenter.v1alpha1.UserCenterService/Login"
	UserCenterService_ResetPassword_FullMethodName = "/zjut.jh.usercenter.v1alpha1.UserCenterService/ResetPassword"
	UserCenterService_Delete_FullMethodName        = "/zjut.jh.usercenter.v1alpha1.UserCenterService/Delete"
	UserCenterService_OauthLogin_FullMethodName    = "/zjut.jh.usercenter.v1alpha1.UserCenterService/OauthLogin"
	UserCenterService_HealthyCheck_FullMethodName  = "/zjut.jh.usercenter.v1alpha1.UserCenterService/HealthyCheck"
)
...
type UserCenterServiceClient interface {
	...
	OauthLogin(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*OauthLoginResponse, error)
...
func (c *userCenterServiceClient) Delete(ctx context.Context, in *DeleteRequest, opts ...grpc.CallOption) (*DeleteResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *userCenterServiceClient) OauthLogin(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*OauthLoginResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type UserCenterServiceServer interface {
	...
	OauthLogin(context.Context, *LoginRequest) (*OauthLoginResponse, error)
...
func (UnimplementedUserCenterServiceServer) Delete(context.Context, *DeleteRequest) (*DeleteResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method Delete not implemented")
}
func (UnimplementedUserCenterServiceServer) OauthLogin(context.Context, *LoginRequest) (*OauthLoginResponse, error) {
...
var UserCenterService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "zjut.jh.usercenter.v1alpha1.UserCenterService",
